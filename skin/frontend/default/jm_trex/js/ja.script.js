...
(function($){
   	equalheight = function(container){
			...
			$(window).load(function() {
			  equalheight('.listing-type-grid li.item, .products-grid li.item, .jm-product-list-bycat .jm-cat-left, .jm-product-list-bycat .jm-cat-center, .jm-product-list-bycat .jm-cat-right');
			});
